//Each node in a BST holds a key, a value, and left and right pointers. 
    ...
    //If the node you are replacing has a parent then you need to wire up the references from the parent to the replacement node, and the replacement node back to the parent. 
